        ...
        <>
            ...
            <div className='relative flex items-center'>
                <div className='relative flex items-center group'>
                    ...
                    <div id={'slider'} className='w-full h-ful overflow-x-scroll whitespace-nowrap scroll scroll-smooth scrollbar-hide relative '>
                        {movies.map((item, id) => (
                            <div key={id} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[200px] inline-block cursor-pointer relative p-2'>
                                <img src={`https://image.tmdb.org/t/p/w500/${item?.backdrop_path}`} alt={item?.img} />
